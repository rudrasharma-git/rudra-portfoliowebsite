...
const Research = () => {
  ...
  return (
    <section
      id="research"
      className="section-bright min-h-screen bg-card text-card-foreground py-24 px-6 relative"
    >
      <div className="container mx-auto max-w-7xl">
        {/* Header with Navigation */}
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <h2 className="text-5xl sm:text-5xl md:text-7xl font-bold animate-fade-in w-full sm:w-auto text-center sm:text-left">
            RESEARCH
          </h2>
        ...
        {/* Scroll Progress Bar */}
        <div className="relative h-1 bg-border rounded-full overflow-hidden mb-8">
          <div
        ...
        {/* Horizontal Scrolling Container with Fade Indicators */}
        <div className="relative">
          {/* Left Fade */}
          {/* <div
            className={`pointer-events-none absolute top-0 left-0 w-7 h-full bg-gradient-to-r from-card to-transparent transition-opacity duration-300 ${
              isAtStart ? "opacity-0" : "opacity-100"
            }`}
          ></div> */}

          {/* Scrollable Research Panels */}
          <div
              ...
              return (
                ...
                >
                  <div className="bg-primary text-primary-foreground rounded-2xl p-6 shadow-strong border-2 border-border hover:border-accent/50 transition-all h-full flex flex-col">
                    ...
                    {/* Description */}
                    <p className="text-sm leading-relaxed text-primary-foreground/80 mb-4 line-clamp-5 flex-grow text-justify">
          ...
          {/* Right Fade */}
          {/* <div
            className={`pointer-events-none absolute top-0 right-0 w-7 h-full bg-gradient-to-l from-card to-transparent transition-opacity duration-300 ${
