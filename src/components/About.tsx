            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-2 border-secondary pl-6">
                  ...
                  <ul className="text-sm text-primary-foreground/70 space-y-1 list-disc list-inside">
                    <li>[Course 1]</li>
                    <li>[Course 2]</li>
                    <li>[Course 3]</li>
                    <li>[Course 4]</li>
          ...
          <div className="space-y-8 animate-slide-in-right">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-2 border-accent pl-6">
                ...
                <ul className="text-sm text-primary-foreground/80 space-y-2 list-disc list-inside">
