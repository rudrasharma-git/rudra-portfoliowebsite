    ...
    >
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-16 animate-fade-in">
          ...
          <p className="text-base leading-relaxed text-primary-foreground max-w-4xl">
          ...
          <div className="space-y-8 animate-slide-in-left">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-2 border-secondary pl-6">
                ...
                <ul className="text-sm text-primary-foreground/80 space-y-1 list-disc list-inside">
          ...
          <div className="space-y-8 animate-slide-in-right">
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-accent pl-6">
                ...
                <ul className="text-sm text-primary-foreground space-y-2 list-disc list-inside">
